        ...
        <View style={{ alignItems: "flex-end", width: "20%" }}>
          <Text
            style={{
              ...
              fontSize: 15,
              fontWeight: 600,
              color: _.get(props, "red_lines") ? "#a9def9" : "#EB4223",
            }}
          >
        ...
        <View style={{ alignItems: "flex-end", width: "20%" }}>
          <Text
            style={{
              ...
              fontSize: 15,
              fontWeight: 600,
              color: _.get(props, "fac_inst_p_req") ? "#a9def9" : "#EB4223",
            }}
          >
        ...
        <View style={{ alignItems: "flex-end", width: "20%" }}>
          <Text
            style={{
              ...
              fontSize: 15,
              fontWeight: 600,
              color: _.get(props, "units_ref_work") ? "#a9def9" : "#EB4223",
            }}
          >
        ...
        <View style={{ alignItems: "flex-end", width: "20%" }}>
          <Text
            style={{
              ...
              fontSize: 15,
              fontWeight: 600,
              color: _.get(props, "area_surr_fac") ? "#a9def9" : "#EB4223",
            }}
          >
...
const InspectionReportDownload = (props) => {
  ...
  useEffect(() => {
    if (!parsed) {
      ...
      const { id, p, j, s, l, u } = parsed;
      console.log(
        `reports/adminreportdata?p=project:${p}&job=${j}&sheet=${s}&ld=${l}&unit=${u}`
      );
        ...
        >
          {({ blob, url, loading, error }) => {
            if (error) console.log("error", error);
              ...
              if (!loading && url) {
                fileDownload(blob, "InspectionReport.pdf");
                //props.onClose();
